...
public class ProjectEntityFactoryBaseCDI implements IProjectEntityFactory {
	private static Logger logger = Logger.getLogger(ProjectEntityFactoryBaseCDI.class.getName());
	public ProjectEntityFactoryBaseCDI() {
	...
	//
	public ProjectEntityFactoryBaseCDI(IProjectEntityRepository entityRepository) {
		super();
